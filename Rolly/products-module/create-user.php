...
<div id="form-block-product">
    <form onsubmit="return Checkproduct()" name="productform" method="POST" action="processes/process.product.php?action=new">
...
<script>
    function Checkproduct() {
        let pname = document.productform.pname.value;
